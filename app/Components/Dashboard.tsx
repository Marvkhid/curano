  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-6 ml-80 flex-grow">
        ...
        <Link href="/remarks-history" className="flex items-center gap-2 cursor-pointer flex-shrink-0">
        ...
        <Link href="/assign-cases" className="flex items-center gap-2 cursor-pointer flex-shrink-0">
        ...
        <Link href="/request-log" className="flex items-center gap-2 cursor-pointer flex-shrink-0">
